...
if __name__ == '__main__':
    # Read image
    im = cv2.imread("InputPhotos/IMG_3483.jpg", cv2.IMREAD_GRAYSCALE)
    ...
    compare_hists = np.hstack((im_med_blur, im_contrast, im_cl))  # stacking images side-by-side
    ...
    im_with_keypoints2 = cv2.drawKeypoints(im_med_blur, keypoints2, blank, (0, 255, 0),
                                          cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
    im_with_keypoints3 = cv2.drawKeypoints(im_cl, keypoints3, blank, (0, 255, 0),
                                          cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
